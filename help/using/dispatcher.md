...
1. Ouvrez le `author_dispatcher.any` dans un éditeur de texte et apportez les modifications suivantes :
   ...
   1. Modifiez `/docroot` dans la section `/cache` pour qu’il pointe vers un répertoire de cache. In case you are using [AEM with Touch UI](https://helpx.adobe.com/experience-manager/6-3/sites/developing/using/touch-ui-concepts.html), see the warning above.
